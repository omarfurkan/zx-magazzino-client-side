    ...
    return (
        <div className=''>
            ...
            <div className=' absolute top-[92px]  lg:top-52 lg:left-60 text-opacity-10'>
                <h1 className='text-center lg:text-left'><span className='text-red-500 font-black lg:text-8xl'>ZX</span><span className='font-qahiri lg:text-8xl text-white '>magazzino</span></h1>
