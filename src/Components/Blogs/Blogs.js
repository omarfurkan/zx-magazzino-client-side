        ...
        <div className='bg-[#F0ECE3] '>
            <div className='w-11/12 mx-auto py-12'>
                ...
                <div className='font-poppins'>
                    <p className='font-bold my-2'>Ques 1. Difference between javascript and nodejs</p>
                    ...
                    <p className='font-bold my-2'>Ques 2.When should we use NodeJS and When should we ue MongoDB</p>
                    <p>MongoDB ans NodeJS are tow different technologies.MongoDB is a database system which gives you a chance to efficiently store documents in a database and to perform operations like data update, or to search documents by some criterias.</p>
                    <br />
                    <p>When to use Nodejs: Any project needs a programming environment and a runtime library that offers you basic programming tool/support and can/or interpret you code. Nodejs is such as tool for the JabaScript programming language.There are  other similar tools for other languages such as Python, Java, #,C++, Go etc.</p>
                    <br />
                    ...
                    <p className='font-bold my-2'>Ques 3. Difference between sql and nosql database.</p>
                    ...
                    <p className='font-bold my-2'>Ques 4. What is the purpose of jwt and how does it work</p>
